...
public class ShowDetails extends GridPane {
...
//        setAlignment(Pos.CENTER);
        ...
        Algorithm.TotalProductivity[][] tot = Algorithm.Knapsack(hours);
        ...
        dpTA.appendText("Dynamic Programming give the optimal solution for every hour on any task");
